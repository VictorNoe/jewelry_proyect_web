...
import {useServicesCategory} from "../hooks/useServicesCategory";
...
export const NavbarClient = () => {
    ...
    const { getProductCategory} = useContext(UseContextCart);
    const {category} = useServicesCategory();
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="me-auto">
                            <NavDropdown title="Categorias">
                                {category.map((cate) => (
                                    <NavDropdown.Item key={cate?.id} onClick={()=> filtro(cate?.id)}>
                                        {cate?.description}
                                    </NavDropdown.Item>
                                ))}
                            </NavDropdown>
